...
<link rel="stylesheet" href="<%=basePath %>images/CSS.css" type="text/css">
          ...
          <script type="text/javascript">
			...
			switch(day)
			{
				...
				case 0:document.write("星期日");break;
         		 ...
         		 腾飞${user.userName}您好!</p> </td>

<td>
<div id="tabsJ">
<ul>
	<li><a href="<%=basePath%>login/backSystem!backSystemaction" target="index" title="Link 5"><span><font color="#FFFFFF">退出系统</font></span></a></li>
 </ul>
</div>
</td>
</tr>
