...
<body>
<form name="Form" method="post" action="changeOra3!updateOragan3"  onsubmit="pass()"  >
<table width="100%" >
  <tr>
    <td> 
...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  ...
  <tr>
    ...
    <td class="TD_STYLE2"><input type="text" id="thirdKindName" name="oragan.oraganName" value="${organ[0].oraganName}" class="INPUT_STYLE1" ></td>
  </tr>
  <tr>
    <td class="TD_STYLE1">上级机构名称</td>
  ...
  <tr>
    ...
    <input type="hidden" id="salarySendId" value="${organ[0].salarypaypersonId}" name="oragan.salarypaypersonId" class="TEXTAREA_STYLE1" />
    </td>
  </tr>
  <tr>
    ...
    <input id="thirdKindSaleId" type="hidden" name="oragan.salepersonId"  value="${organ[0].salepersonId}" class="TEXTAREA_STYLE1" />
    </td>
  </tr>
</table>
</form>
