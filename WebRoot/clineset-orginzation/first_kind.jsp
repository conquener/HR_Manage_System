...
<html>
	<head>
		...
		<script type="text/javascript" >
			...
			{	
				if(confirm("确定要删除吗？")) {
					location.href = "deleteOrgan1!deleteOrgan1?oraganId=" + id;
				}
			}					
	...
	<body>
		<form method="post" action="manpower!loadOragan1?level=1">
			<table width="100%">
				<tr>
					<td>
						...
						<c:choose>
							...
							<c:forEach items="${Organization}" var="o" end="${OrganizationSize-2}">
								<tr>
									...
									<td class="TD_STYLE2">
										<a href="changeLoad1!queryOraganById1?oraganId=${o.oraganId}">变更</a>
									</td>
									<td class="TD_STYLE2">
