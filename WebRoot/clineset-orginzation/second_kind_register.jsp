...
<body>
<form name="Form" method="post" action="insertOrgan2!insertOrgan2"  onsubmit="pass()"  >
<table width="100%" >
  <tr>
    <td> 
...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  <tr>
    ...
    <td class="TD_STYLE2"><input type="text" id="secondKindName" name="oragan.oraganName" value="" class="INPUT_STYLE1" ></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input id="secondKindSaleId" type="hidden" name="oragan.salepersonId"  class="TEXTAREA_STYLE1" />
    </td>
  </tr>
</table>
</form>
