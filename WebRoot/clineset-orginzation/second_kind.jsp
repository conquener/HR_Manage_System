...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				if(confirm("确定要删除吗？")) {
					location.href = "deleteOrgan2!deleteOrgan2?oraganId=" + id;
				}
			}
	...
	<body>
		<form method="post" action="manpower!loadOragan1?level=2">
			<table width="100%">
				<tr>
					<td>
						<u><font color="#0000cc">您正在做的业务是：人力资源--客户化设置--人力资源档案管理设置--II级机构设置 
						</font></u>
					</td>
				</tr>
				<tr>
					<td align="right">
						<u><input type="button" value="添加" class="BUTTON_STYLE1" onclick="window.location.href='updateLoad!queryByParentId'"></u>
					</td>
				</tr>
			</table>
							...
							<c:when test="${OrganizationSize>1}">
								<c:forEach items="${Organization}" var="o" end="${OrganizationSize-2}">
									<tr>
										...
										<td class="TD_STYLE2">
											<a href="changeLoad2!queryOraganById2?oraganId=${o.oraganId}">变更</a>
										</td>
										<td class="TD_STYLE2">
