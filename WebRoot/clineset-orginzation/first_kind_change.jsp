...
<form name="Form" method="post" action="changeOra1!updateOragan1"  onsubmit="pass()"  >
<table width="100%" >
  <tr>
    <td> 
...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  <tr>
    ...
    <input type="hidden" name="oragan.parentId" value="${organ[0].parentId}" />
    </td>
  </tr>
  <tr>
    <td class="TD_STYLE1">I级机构名称</td>
    <td class="TD_STYLE2"><input type="text" id="firstKindName" name="oragan.oraganName" value="${organ[0].oraganName}" class="INPUT_STYLE1" ></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input id="firstKindSaleId" type="hidden" name="oragan.salepersonId" value="${organ[0].salepersonId}"  class="TEXTAREA_STYLE1" />
    </td>
  </tr>
</table>
</form>
