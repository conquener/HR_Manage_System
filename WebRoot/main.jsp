...
<table width="830" height="400" border="0" align="left">
  <tr>
  	<td width="120">
	      ...
	      <div align="right">
			<a target="a" onMouseOver="MM_swapImage('image0','','images/images/config1.gif',1)" onMouseOut="MM_swapImgRestore()">
	      		<img src="images/images/config.gif" width="55" height="55" name="image0" alt="客户化设置"></a>
	      </div>
     	</div>
 	 </td>
    <td width="120" height="38">
	  <div align="center">
	    <div align="right">
	  		<a target="a" onMouseOver="MM_swapImage('image1','','images/images/file1.gif',1)" onMouseOut="MM_swapImgRestore()">        
		    	<img src="images/images/file.gif" width="55" height="55" name="image1" alt="人力资源档案管理">
		    </a>
	    </div>
	  </div>
	</td>
    <td width="118">
	      <div align="right">
			<a target="a" onMouseOver="MM_swapImage('image2','','images/images/salary_standard1.gif',1)" onMouseOut="MM_swapImgRestore()">
	      		<img src="images/images/salary_standard.gif" width="55" height="55" name="image2" alt="薪酬标准管理">
	      	</a>
	      </div>
      </td>
    <td width="120">
      <div align="right">
		  <a target="a" onMouseOver="MM_swapImage('image3','','images/images/salary1.gif',1)" onMouseOut="MM_swapImgRestore()">
	     	 <img src="images/images/salary.gif" width="55" height="55" name="image3" alt="薪酬发放管理">
	      </a>
      </div>
    </td>
    <td width="120">
      <div align="right">
		  <a target="a" onMouseOver="MM_swapImage('image4','','images/images/major_change1.gif',1)" onMouseOut="MM_swapImgRestore()">
	      	<img src="images/images/major_change.gif" width="55" height="55" name="image4" alt="调动管理">
	      </a>
      </div>
      </td>
  </tr>
 	...
 	<td width="120">
	    <div align="right">
		    <a target="a" onMouseOver="MM_swapImage('image5','','images/images/training1.gif',1)" onMouseOut="MM_swapImgRestore()">
		   		<img src="images/images/training.gif" width="55" height="55" name="image5" alt="培训管理">
		    </a>
	    </div>
	</td>
    <td width="120" height="55"><div align="center">
	  <div align="right">
	      <a target="a" onMouseOver="MM_swapImage('image6','','images/images/bonus1.gif',1)" onMouseOut="MM_swapImgRestore()">      
		 	 <img src="images/images/bonus.gif" width="55" height="55" name="image6" alt="激励管理">
		  </a>
	  </div>
	  </div>
	</td>
    <td width="118">
      <div align="right">
	      <a target="a" onMouseOver="MM_swapImage('image7','','images/images/engage1.gif',1)" onMouseOut="MM_swapImgRestore()">
	      	<img src="images/images/engage.gif" width="55" height="55" name="image7" alt="招聘管理">
	      </a>
      </div>
    </td>
    <td width="120"><div align="center">
	   <div align="right">
	      	<a target="a" onMouseOver="MM_swapImage('image8','','images/images/export1.gif',1)" onMouseOut="MM_swapImgRestore()">
		  		<img src="images/images/export.gif" width="55" height="55" name="image8" alt="标准数据报表">
		  	</a>
	   </div>
   	</div>
   </td>
